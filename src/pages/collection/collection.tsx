...
const Collection = () => {
  ...
  const sortProduct = () => {
    ...
    // Nếu điều_kiện đúng → thực hiện biểu thức sau dấu ?.
    // Nếu điều_kiện sai → thực hiện biểu thức sau dấu :.
    let fpCopy = Array.isArray(filterProducts) ? [...filterProducts] : [];
    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
        ...
        <div className="min-w-60">
          ...
          <div
            className={
              "border border-gray-300 pl-5 py-3 my-5 ${showFilter ? '':'hidden'} sm:block"
            }
          >
